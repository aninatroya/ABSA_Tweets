...
def plot_confusion_matrix(cm,
                          ...
                          cmap=None,
                          normalize=True, filepath='/content/drive/MyDrive/ABSA/plots/confusion_matrix_aspects.jpg'):
    """
    ...
    plt.show()
    # plt.savefig('/content/drive/MyDrive/ABSA/plots/confusion_matrix.jpg')
    fig.savefig(filepath)
    return plt


def custom_classification_report(truth_labels=None, predicted_labels=None):
    """
    :param truth_labels:
    :param predicted_labels:
    :return:
    """
    return classification_report(truth_labels, predicted_labels)
